...
describe('Factory', () => {
  ...
  describe('Upgradable', ()=>{
    it('deploys TestFactory as upgradable', async () => {
    ...
    it('Should be able to upgrade TestFactory', async () => {
      await util.deployTestFactory("upgradable")
      await util.upgradeTestFactory()
      let version = await util.testFactory.version()
      expect(version).to.equal(2)
    })
    it('Upgraded factory - should not be re-initialized', async () => {
      await util.deployTestFactory("upgradable")
      await util.upgradeTestFactory()
    ...
    it('Upgraded factory - should have implementation version of 1 before updating implementation', async () => {
      await util.deployTestFactory("upgradable")
      await util.upgradeTestFactory()
      let implementationAddress = await util.testFactory.CurrentImplementation()
      let implementation = util.getContract(implementationAddress, "TestThing", util.deployer)
    ...
    it('Upgraded factory - not updated implementation makes clones of version 1', async () => {
      await util.deployTestFactory("upgradable")
      await util.upgradeTestFactory()
      await util.testFactory.createClone(util.deployer.address)
      let clones = await util.testFactory.getClones()
    ...
    it('Upgraded factory - updated implementation reflects version of 2', async () => {
      await util.deployTestFactory("upgradable");
      await util.upgradeTestFactory()
    ...
    it('Upgraded factory - updated implementation can make clones of version 2', async () => {
      await util.deployTestFactory("upgradable");
      await util.upgradeTestFactory()
      await util.testFactory.updateImplementation()
    ...
    it('Upgraded factory - updated implementation should be able to clone version 1', async () => {
      await util.deployTestFactory("upgradable");
      await util.upgradeTestFactory()
      await util.testFactory.updateImplementation()
      await util.testFactory.createClone(util.deployer.address)
    ...
    it('Upgraded factory - clones should be owned by deployer', async () => {
      await util.deployTestFactory("upgradable");
      await util.upgradeTestFactory()
      await util.testFactory.createClone(util.deployer.address)
      let clones = await util.testFactory.getClones()
...
describe('Thing', ()=>{
  it('should be able to be deployed as non upgradable')
  it('should be able to be deployed as upgradable')
  it('should be able to be upgraded')
})
